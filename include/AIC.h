 ...
 * 
 * Description: Header file to perform Active Inference Control of the 5-DOF Interbotix PincherX 150 robotic manipulator using ROS.
 * 
...
private:
  ...
  // Variances associated with the AIC and the confidence relative to sensory input and beliefs
  ...
  ros::NodeHandle nh;
  // Publishers for joint control actions to the topics, and the free-energy
